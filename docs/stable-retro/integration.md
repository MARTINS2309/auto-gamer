# Game Integration[¶](https://stable-retro.farama.org/integration/#game-integration "Link to this heading")
...
If you are going to integrate a new game, you’ll need a ROM for the correct system, see [Supported ROM Types](https://stable-retro.farama.org/integration/#supported-roms) for a list.

## Example Integration[¶](https://stable-retro.farama.org/integration/#example-integration "Link to this heading")
...
### `Level1.state`[¶](https://stable-retro.farama.org/integration/#level1-state "Link to this heading")
...
### `data.json`[¶](https://stable-retro.farama.org/integration/#data-json "Link to this heading")

This file defines the list of game-related variables that python can see based on their memory addresses in the games

### `scenario.json`[¶](https://stable-retro.farama.org/integration/#scenario-json "Link to this heading")

This file defines the reward function and done condition using the variables defined in `data.json`

### `metadata.json`[¶](https://stable-retro.farama.org/integration/#metadata-json "Link to this heading")
...
### `rom.md`[¶](https://stable-retro.farama.org/integration/#rom-md "Link to this heading")
...
### `rom.sha`[¶](https://stable-retro.farama.org/integration/#rom-sha "Link to this heading")
...
## Integration Files[¶](https://stable-retro.farama.org/integration/#integration-files "Link to this heading")

### States[¶](https://stable-retro.farama.org/integration/#states "Link to this heading")
...
### Variable Locations `data.json`[¶](https://stable-retro.farama.org/integration/#variable-locations-data-json "Link to this heading")
...
For more information on the possible variable types, see [Appendix: Types](https://stable-retro.farama.org/integration/#appendix-types).

### Scenario `scenario.json`[¶](https://stable-retro.farama.org/integration/#scenario-scenario-json "Link to this heading")

Information pertaining to reward functions and done conditions can either be specified by manually overriding functions in [`stable_retro.RetroEnv`](https://stable-retro.farama.org/python/#stable_retro.RetroEnv "stable_retro.RetroEnv") or can be done by writing a scenario file.

Scenario files contain information that is used to compute the reward function and done condition from variables defined in the information manifest. Each variable specified in the scenario file is multiplied by a `reward` value if positive and a `penalty` value if negative and then summed up to create the reward for that step. Similarly, states of these variables can be checked to see if the game is over. By default the scenario file will be loaded from `scenario.json`, but alternative scenario files can be specified in the [`stable_retro.RetroEnv`](https://stable-retro.farama.org/python/#stable_retro.RetroEnv "stable_retro.RetroEnv") constructor.
...
For more information on the conditions that can be defined, see [Appendix: Operations](https://stable-retro.farama.org/integration/#appendix-operations).

## The Integration UI[¶](https://stable-retro.farama.org/integration/#the-integration-ui "Link to this heading")
...
-   [Windows Integration UI](https://stable-retro.farama.org/integration/#TODO)
    
-   [Mac Integration UI](https://stable-retro.farama.org/integration/#TODO)
...
### Integrating a new ROM[¶](https://stable-retro.farama.org/integration/#integrating-a-new-rom "Link to this heading")
...
-   If the ROM has a `.bin` extension, rename it to have the correct extension for that system listed in [Supported ROM Types](https://stable-retro.farama.org/integration/#supported-roms)
...
## Supported ROM Types[¶](https://stable-retro.farama.org/integration/#supported-rom-types "Link to this heading")
...
## Integrating a Game[¶](https://stable-retro.farama.org/integration/#integrating-a-game "Link to this heading")
...
### Done Condition[¶](https://stable-retro.farama.org/integration/#done-condition "Link to this heading")
...
### Reward Function[¶](https://stable-retro.farama.org/integration/#reward-function "Link to this heading")
...
### Finding Variables[¶](https://stable-retro.farama.org/integration/#finding-variables "Link to this heading")
...
### Common Errors[¶](https://stable-retro.farama.org/integration/#common-errors "Link to this heading")
...
## Using a Custom Integration from Python[¶](https://stable-retro.farama.org/integration/#using-a-custom-integration-from-python "Link to this heading")
...
def main():
        retro.data.Integrations.add\_custom\_path(
                os.path.join(SCRIPT\_DIR, "custom\_integrations")
        )
        print("FakeGame-Nes" in retro.data.list\_games(inttype\=retro.data.Integrations.ALL))
...
## Appendix: Types[¶](https://stable-retro.farama.org/integration/#appendix-types "Link to this heading")
...
_NB_: The nybbles `0xA` - `0xF` cannot occur in binary-coded decimal.
...
>     
> -   `<u3`: Non-power of two bytes (i.e. `0x010203` -> `0x03 0x02 0x1`)
>     
...
## Appendix: Operations[¶](https://stable-retro.farama.org/integration/#appendix-operations "Link to this heading")
